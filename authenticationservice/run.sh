...
echo "********************************************************"
while ! `nc -z postgres-data $DATABASESERVER_PORT`; do sleep 3; done
...
echo "********************************************************"
echo "Starting Authentication Server with Configuration Service via Eureka :  $EUREKASERVER_URI:$SERVER_PORT"
